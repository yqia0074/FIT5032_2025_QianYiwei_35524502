...
const AppointmentBooking = defineAsyncComponent(() => import('./AppointmentBooking.vue'))
...
const modules = [
  ...
  },
  {
    ...
    description: 'Schedule counseling sessions and mental health appointments with qualified professionals.',
    icon: 'bi-calendar-check',
    component: markRaw(AppointmentBooking),
    priority: {
      'Happy': 5,
      'Calm': 5,
      'Sad': 1,
